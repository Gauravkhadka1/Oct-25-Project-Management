...
class MentionedUserNotificationProspect extends Mailable
{
    ...
    public function __construct(Activity $activity, User $mentionedUser, User $mentioningUser,  $companyName)
    {
    ...
    public function build()
    {
        ...
        return $this->subject('You were mentioned in a comment')
                    ...
                    ->with([
                        ...
                        'activityLink' => route('payments.show', $this->activity->prospect_id),
                    ]);
    }
}
