            ...
            $('#message').on('keyup', function(e) {
                ...
                if (atIndex !== -1 && (value.length === atIndex + 1)) {
                    $.ajax({
                        ...
                        data: {
                            query: ''
                        }, // Send an empty query to fetch all usernames
...
</html><?php /**PATH C:\xampp\htdocs\Oct 29- Live edited-project management\resources\views/frontends/mention.blade.php ENDPATH**/ ?>