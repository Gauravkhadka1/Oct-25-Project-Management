...
<main>
            ...
            <tr>
                ...
                <th id="company-name">
                    ...
                    <img 
                        ...
                        src="<?php echo e(url('public/frontend/images/sort.png')); ?>" 
                        alt="Sort" 
                        data-order="<?php echo e(request('sort_order') === 'asc' ? 'desc' : 'asc'); ?>" 
    ...
    <img 
        ...
        src="<?php echo e(url('public/frontend/images/sort.png')); ?>" 
        alt="Sort" 
        data-order="<?php echo e(request('sort_by') === 'website' && request('sort_order') === 'asc' ? 'desc' : 'asc'); ?>" 
        style="cursor: pointer;" 
    ...
    <script>
        ...
        const url = `<?php echo e(route('clients.index')); ?>?sort_by=company_name&sort_order=${sortOrder}`; // Build URL for sorting
