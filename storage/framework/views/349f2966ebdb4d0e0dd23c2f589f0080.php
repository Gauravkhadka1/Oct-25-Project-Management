...
<body>
  <div class="wrapper">
    ...
    <li><a href="<?php echo e(route('expiry.index', ['days_filter' => '7-1', 'sort' => request('sort'), 'column' => request('column')])); ?>">
        <div class="days">7 Days</div>
        <div class="expiry-count"><?php echo e($servicesIn7To1Days); ?></div>
    </a></li>
    <li><a href="<?php echo e(route('expiry.index', ['days_filter' => 'today', 'sort' => request('sort'), 'column' => request('column')])); ?>">
        ...
        <div class="expiry-count"><?php echo e($servicesExpiringToday); ?></div>
    </a></li>
    <li>
    <a href="<?php echo e(route('expiry.index', ['days_filter' => 'expired', 'sort' => request('sort'), 'column' => request('column')])); ?>">
        ...
        <div class="expiry-count"><?php echo e($expiredServicesCount); ?></div>
    </a>
</li>
