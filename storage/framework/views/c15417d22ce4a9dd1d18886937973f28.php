        ...
        <th>Edit</th>
            ...
            <?php $__currentLoopData = $prospects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $prospect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <span class="prospect-name"><?php echo e($prospect->name); ?></span>
                        <button class="btn-see-details" data-phone="<?php echo e($prospect->phone_number); ?>" data-email="<?php echo e($prospect->email); ?>" data-message="<?php echo e($prospect->message); ?>">
                            See Details
                        </button>
                    </td>
...
<?php echo $__env->make('frontends.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Oct-25-Project-Management\resources\views/frontends/prospects.blade.php ENDPATH**/ ?>