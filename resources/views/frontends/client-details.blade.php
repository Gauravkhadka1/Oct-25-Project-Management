                ...
                <div class="installments">
                    ...
                    <div id="installment-dates" class="installment-dates">
                        ...
                        <div class="first-installment_amount">
                            ...
                            <input type="number" name="first_installment_amount" value="{{$client->first_installment_amount}}">
                        </div>
                        </div>
                        ...
                        <div class="first-installment_amount">
                            <label for="">Amount</label>
                            <input type="number" name="second_installment_amount" value="{{$client->second_installment_amount}}">
                        </div>
                        </div>
                        <div class="first-installment-inputs">
                        <div class="first-installment">
                            <label for="">3rd Inst.. Date</label>
                            <input type="date" name="third_installment" value="{{$client->third_installment_amount}}">
                        </div>
                        <div class="first-installment_amount">
                            <label for="">Amount</label>
                            <input type="number" name="third_installment_amount" value="{{$client->third_installment_amount}}">
                        </div>
                        </div>
                        <div class="first-installment-inputs">
                        <div class="first-installment">
                        ...
                        <div class="first-installment_amount">
                            <label for="">Amount</label>
                            <input type="number" name="fourth_installment_amount" value="{{$client->fourth_installment_amount}}">
                        </div>
                        </div>
                    </div>
                </div>
