        ...
        <div class="tasks-in-details">
            <div class="task-details-one">
                <div class="task-status">
                 <p class="labels">Status:</p>  <p class="datas">{{ $task->status ?? 'TO DO' }}</p>
                </div>
                <div class="task-start-date">
                <p class="labels">Start Date:</p><p class="datas">{{ $task->start_date }}</p> 
                </div>
                <div class="task-due-date">
                <p class="labels">Due Date:</p> <p class="datas">{{ $task->due_date }}</p> 
                </div>
            ...
            <div class="task-details-two">
                ...
                <p class="labels"> Assigned to:</p> 
                    ...
                    <img
                        src="{{ $task->assignedTo->profilepic ? asset('storage/profilepics/' . $task->assignedTo->profilepic) : asset('images/default-profile.png') }}"
                        alt="{{ $task->assignedTo->name }}'s Profile Picture"
                ...
                <p class="labels">  Assigned By:</p> 
                    ...
                    <img
                        src="{{ $task->assignedBy->profilepic ? asset('storage/profilepics/' . $task->assignedBy->profilepic) : asset('images/default-profile.png') }}"
                        alt="{{ $task->assignedBy->name }}'s Profile Picture"
                        class="user-profile-pic">
                </div>
                <div class="task-due-date">
